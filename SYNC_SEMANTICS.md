...
**SS-12.3 — User-facing copy.** Ordinary states are “Updating this device,” “Updates waiting until the workout ends,” “Retry needed” through the existing drift surface, and “Needs your choice” for a proven same-entity conflict. Technical detail remains in Advanced.

**SS-12.4 — Deployment boundary.** This contract and its implementation do not authorize a production deployment, Supabase mutation, GitHub snapshot retirement, PR, merge, or release. Rollout remains separately controlled by SS-12.1.
