...
bind('activeExercises','click',e=>{
  ...
  if(t.dataset.addSet!==undefined){const exerciseIndex=Number(t.dataset.addSet);active.focusedExerciseId=active.exercises[exerciseIndex].id;acknowledgeTimerReady();active.exercises[exerciseIndex].sets.push({id:uid(),weight:'',reps:'',warmup:false,completed:false});autosave();renderActive();return;}
