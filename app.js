...
const RAW=[
['Seated Machine Chest Press','Push','Chest','Machine'],['Incline Iso Machine Press','Push','Chest','Machine'],['Smith Machine Incline Press','Push','Chest','Smith Machine'],['Barbell Bench Press','Push','Chest','Barbell',['Bench','Barbell Bench']],['Dumbbell Bench Press','Push','Chest','Dumbbell',['DB Bench']],['Incline Dumbbell Press','Push','Chest','Dumbbell',['DB Incline Press','Incline DB Press']],['Cable Chest Fly','Push','Chest','Cable'],['Seated Pec Deck','Push','Chest','Machine',['Pec Fly Machine','Pec Deck','Machine Pec Fly']],['Push-Up','Push','Chest','Bodyweight'],['Dips','Push','Chest / Triceps','Bodyweight'],
['Iso Machine Shoulder Press','Push','Shoulders','Machine',['Iso Shoulder Press']],['Dumbbell Shoulder Press','Push','Shoulders','Dumbbell',['DB Shoulder Press']],['Barbell Overhead Press','Push','Shoulders','Barbell'],['Machine Shoulder Press','Push','Shoulders','Machine'],['Dumbbell Lateral Raise','Push','Shoulders','Dumbbell',['DB Lat Raise','DB Lateral Raise']],['Cable Lateral Raise','Push','Shoulders','Cable',['Cable Lat Raise']],['Reverse Pec Deck','Pull','Rear Delts','Machine'],['Face Pull','Pull','Rear Delts','Cable',['Face Pulls']],
...
['Lat Pulldown','Pull','Back','Cable'],['Iso-Lateral Pulldown Machine','Pull','Back','Machine',['Iso Lat Pull Machine','Iso Lat Pulldown Machine']],['Assisted Pull-Up','Pull','Back','Machine'],['Pull-Up','Pull','Back','Bodyweight',['Pull ups','Pullup','Pullups']],['Seated Cable Row','Pull','Back','Cable',['Cable Row']],['Chest-Supported Row','Pull','Back','Machine'],['T-Bar Row','Pull','Back','Machine'],['Barbell Row','Pull','Back','Barbell'],['One-Arm Dumbbell Row','Pull','Back','Dumbbell'],['Iso-Lateral Row','Pull','Back','Machine',['One Arm Row Machine','One-Arm Row Machine','Iso Row Machine']],['Straight-Arm Pulldown','Pull','Back','Cable'],['Machine Pullover','Pull','Back','Machine'],['Rack Pull','Pull','Back','Barbell'],['Dumbbell Shrug','Pull','Traps','Dumbbell',['DB Shrug','DB Shrugs']],['Barbell Shrug','Pull','Traps','Barbell',['Barbell Shrugs']],
['Dumbbell Curl','Pull','Biceps','Dumbbell',['DB Curl','DB Curls']],['Hammer Curl','Pull','Biceps','Dumbbell',['Hammer Curls']],['Incline Dumbbell Curl','Pull','Biceps','Dumbbell'],['Preacher Curl','Pull','Biceps','EZ Bar'],['Machine Preacher Curl','Pull','Biceps','Machine'],['Cable Curl','Pull','Biceps','Cable'],['Bayesian Cable Curl','Pull','Biceps','Cable'],['EZ-Bar Curl','Pull','Biceps','EZ Bar',['EZ Bar Curl','EZ Curl']],
['Back Squat','Legs','Quads / Glutes','Barbell',['Squat','Barbell Squat']],['Front Squat','Legs','Quads','Barbell',['Front Barbell Squat']],['Hack Squat','Legs','Quads / Glutes','Machine'],['Leg Press','Legs','Quads / Glutes','Machine'],['Single-Leg Press','Legs','Quads / Glutes','Machine',['Single Leg Press','Unilateral Leg Press']],['Smith Machine Squat','Legs','Quads / Glutes','Smith Machine'],['Goblet Squat','Legs','Quads / Glutes','Dumbbell'],['Bulgarian Split Squat','Legs','Quads / Glutes','Dumbbell'],['Walking Lunge','Legs','Quads / Glutes','Dumbbell'],['Leg Extension','Legs','Quads','Machine'],
['Romanian Deadlift','Legs','Hamstrings / Glutes','Barbell',['RDL','Barbell RDL']],['Dumbbell Romanian Deadlift','Legs','Hamstrings / Glutes','Dumbbell'],['Seated Leg Curl','Legs','Hamstrings','Machine',['Leg Curl']],['Lying Leg Curl','Legs','Hamstrings','Machine'],['Hip Thrust','Legs','Glutes','Barbell'],['Glute Bridge','Legs','Glutes','Bodyweight'],['Cable Pull-Through','Legs','Glutes','Cable'],['Standing Calf Raise','Legs','Calves','Machine'],['Seated Calf Raise','Legs','Calves','Machine'],['Calf Press on Leg Press','Legs','Calves','Machine',['Calf Raise on Leg Press Machine','Calf Press','Leg Press Calf Raise']],['Hip Abductor','Legs','Glutes','Machine'],
...
const EXERCISES=RAW.map(([name,day,muscle,equipment,aliases=[]])=>Object.freeze({
  id:slug(name),name,day,muscle,equipment,aliases:Object.freeze([...aliases])
}));
...
bind('activeExercises','click',e=>{
  ...
  if(t.dataset.completeSet){const exerciseIndex=Number(t.dataset.ei),set=active.exercises[exerciseIndex].sets[Number(t.dataset.si)];if(!Number(set.weight)||!Number(set.reps))return;focusActiveExercise(exerciseIndex);acknowledgeTimerReady();set.completed=!set.completed;autosave();renderActive();if(set.completed){startRestTimer(exerciseIndex);requestAnimationFrame(()=>{if(!active)return;const result=workoutControlsApi.advanceAfterCompletion(active,exerciseIndex);if(!result.advanced)return;autosave();renderActive();if(result.nextIndex>=0&&!matchMedia('(prefers-reduced-motion: reduce)').matches)requestAnimationFrame(()=>document.querySelectorAll('#activeExercises .active-exercise')[result.nextIndex]?.scrollIntoView({behavior:'smooth',block:'nearest'}));});}}
});
