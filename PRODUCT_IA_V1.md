...
| **7. Programming Engine v1** | Documentation contract approved; runtime remains deferred. Proposal-only structural changes with reasons, diffs, evidence, and Review authority | Analyzer, Goal inputs, constraints, versioned proposal/allocation policy |
