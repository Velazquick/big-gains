...
- Pending sync, reconciliation, conflict, migration, managed-profile recovery, or Program recovery blocks Finish/Discard. Guards are rechecked at action time. Resume remains available inside the existing authorized shell. No queue, recovery, or synchronization mechanism changes.
