...
const CURRENT_CACHE = 'big-gains-shell-v55-phase4i-analytics-library';
const PREVIOUS_CACHE = 'big-gains-shell-v54-managed-member-bootstrap-guard';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v55-phase4i-analytics-library');
