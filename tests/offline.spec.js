...
const CURRENT_CACHE = 'big-gains-shell-v44-calendar-retrospective-workouts';
const PREVIOUS_CACHE = 'big-gains-shell-v43-phase4-account-foundation';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v44-calendar-retrospective-workouts');
