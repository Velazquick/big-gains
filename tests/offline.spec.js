...
const CURRENT_CACHE = 'big-gains-shell-v60-fresh-device-recovery';
const PREVIOUS_CACHE = 'big-gains-shell-v59-timer-reliability-visibility';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v60-fresh-device-recovery');
