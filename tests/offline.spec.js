...
const CURRENT_CACHE = 'big-gains-shell-v40-phase3-workout-hierarchy';
const PREVIOUS_CACHE = 'big-gains-shell-v39-ios-timer-audio-fallback';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v40-phase3-workout-hierarchy');
