...
const CURRENT_CACHE = 'big-gains-shell-v61-partial-blank-fresh-recovery';
const PREVIOUS_CACHE = 'big-gains-shell-v60-fresh-device-recovery';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v61-partial-blank-fresh-recovery');
