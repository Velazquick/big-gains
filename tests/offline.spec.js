...
const CURRENT_CACHE = 'big-gains-shell-v42-training-calendar-controls';
const PREVIOUS_CACHE = 'big-gains-shell-v41-phase3-completion-experience';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v42-training-calendar-controls');
