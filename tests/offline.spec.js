...
const CURRENT_CACHE = 'big-gains-shell-v41-phase3-completion-experience';
const PREVIOUS_CACHE = 'big-gains-shell-v40-phase3-workout-hierarchy';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v41-phase3-completion-experience');
