...
const CURRENT_CACHE = 'big-gains-shell-v43-phase4-account-foundation';
const PREVIOUS_CACHE = 'big-gains-shell-v42-training-calendar-controls';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v43-phase4-account-foundation');
