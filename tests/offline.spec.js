...
const CURRENT_CACHE = 'big-gains-shell-v56-phase4j-progress-dashboard';
const PREVIOUS_CACHE = 'big-gains-shell-v55-phase4i-analytics-library';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v56-phase4j-progress-dashboard');
