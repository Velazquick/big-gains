...
const CURRENT_CACHE = 'big-gains-shell-v54-managed-member-bootstrap-guard';
const PREVIOUS_CACHE = 'big-gains-shell-v53-phase4h-managed-profile-access';
...
test('first install precaches one complete, revision-consistent app shell', async ({ page }) => {
  ...
  expect(state.release).toBe('v54-managed-member-bootstrap-guard');
