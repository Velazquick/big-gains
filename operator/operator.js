(() => {
  ...
  function reliability(r){
    ...
    if(signal==='recovery')$('pagination').hidden=true;else paginate(signal==='errors'?(r.error_group_total||0):signal==='conflicts'?(r.episode_total||0):Math.max(r.error_group_total||0,r.episode_total||0),25);
